<template>
  <div class="modifier-cart-amount-button">
    <button class="bg-indigo-50" @click="() => decrementCartItem(props.productId, 1, props.token)">
    ...
    <button class="bg-indigo-50" @click="() => incrementCartItem(props.productId, 1, props.token)">
      <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
